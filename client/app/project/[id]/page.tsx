...
export default function ProjectPage() {
  ...
  const handleUploadQuestionnaire = async () => {
    ...
    try {
      ...
      toast.success(
        `Uploaded questionnaire with ${res.data.questions.length} questions`,
      );
      setQuestFile([]);
      fetchProject();
    } catch (err: any) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      toast.success(
        `Generated answers for ${res.data.results.length} questions!`,
      );
            ...
            {refFiles.length > 0 && (
              ...
              >
                {uploadingRefs ? (
                  ...
                  <>
                    <Upload size={14} /> Upload {refFiles.length} file(s)
                  </>
                )}
              </button>
            )}
            ...
            {questFile.length > 0 && (
              ...
              >
                {uploadingQuest ? (
                  ...
                  <>
                    <Upload size={14} /> Upload Questionnaire
                  </>
                )}
              </button>
            )}
          ...
          {generating ? (
            <div className="fade-in">
              ...
              <p style={{ color: "var(--color-text-secondary)", fontSize: 14 }}>
                Analyzing your reference documents and generating answers. This
                may take a minute.
              </p>
            </div>
          ) : (
